...
FASTQ=$(sed "${SLURM_ARRAY_TASK_ID}q;d" B19V_fastqs.txt | cut -f 1)
FASTQ_NAME1=$(basename ${FASTQ} .fastq.gz)

OUTPUT=bwa_alignment

# Other necessary paths
REFERENCE=B19V_gen2_ON023027.fasta
FASTQ_NAME=${FASTQ_NAME1}_B19V_gen2_ON023027
# REFERENCE=HBV_D4_FJ692533.2.fasta
# FASTQ_NAME=${FASTQ_NAME1}_HBV_D4_FJ692533.2
